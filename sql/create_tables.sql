...
ALTER TABLE public.events_genres ALTER COLUMN id ADD GENERATED ALWAYS AS IDENTITY (
    SEQUENCE NAME public.events_genres_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
COPY public.events (id, title, release_date, runtime, mpaa_rating, description, image, created_at, updated_at) FROM stdin;
...
COPY public.events_genres (id, event_id, genre_id) FROM stdin;
1	1	5
2	1	12
3	2	5
4	2	11
...
--
-- Name: events_genres_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.events_genres_id_seq', 6, true);
...
--
-- Name: events_genres events_genres_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.events_genres
...
--
-- Name: events_genres events_genres_genre_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.events_genres
    ADD CONSTRAINT events_genres_genre_id_fkey FOREIGN KEY (genre_id) REFERENCES public.genres(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- Name: events_genres events_genres_event_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.events_genres
    ADD CONSTRAINT events_genres_event_id_fkey FOREIGN KEY (event_id) REFERENCES public.events(id) ON UPDATE CASCADE ON DELETE CASCADE;
